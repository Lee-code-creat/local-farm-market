...
/**
 * Get messages for a product where the current user is buyer or seller.
 */
...
/**
 * Post a new message.
 * First message must be from a buyer; later messages restricted to the same buyer and seller.
 */
router.post("/", authMiddleware, (req, res) => {
  ...
  db.get(
    ...
    (err, product) => {
      ...
      // Check if this product already has a conversation
      db.get(
        `
